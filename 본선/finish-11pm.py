...
class BridgeSelection:
    def __init__(self, master):
        ...
        self.bridges = ["동작대교", "동호대교", "잠실대교", "청담대교", "가양대교", "성산대교", "양화대교", 
...
class AnomalyRecordsApp:
    def __init__(self, master):
        ...
        button_width = 30  # 버튼의 너비를 지정합니다.
        button_height = 2  # 버튼의 높이를 지정합니다.
...
class LoginScreen:
    ...
    def check_credentials(self):
        ...
        # username: mechanics, password: mechanics
        if username == 'mechanics' and password == 'mechanics':
...
class DecibelApp:
    ...
    def show_alert(self):
        messagebox.showwarning("경보", "청담대교에서 100dB로 급격히 증가하였습니다! CCTV 영상을 송출합니다.")
