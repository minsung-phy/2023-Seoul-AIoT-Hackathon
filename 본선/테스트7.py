...
class LoginScreen:
    def __init__(self, master):
        ...
        self.logo_image = ImageTk.PhotoImage(file="/Users/mushroom913/Documents/서울시 aiot/photo.png")
        ...
        for idx in range(12):
            ...
            if idx == 6 and decibel == 100 and not self.alert_triggered[idx]:
                ...
                def alert_and_play_video():
                    self.show_alert()
                    self.play_video('/Users/mushroom913/Documents/서울시 aiot/video.mp4')
